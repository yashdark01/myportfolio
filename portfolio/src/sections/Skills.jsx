...
import {
  ...
  FaJsSquare,
  FaGitSquare,
} from "react-icons/fa"; // Corrected icons
...
const skills = [
  ...
  },
  {
    ...
    description:
      "Backend JavaScript runtime used for building scalable applications and APIs.",
  },
  {
    name: "Tailwind CSS",
    level: 90,
    ...
    description:
      "Utility-first CSS framework used to create responsive and modern user interfaces.",
  },
  {
    name: "MongoDB",
    level: 75,
    ...
    description:
      "NoSQL database used for scalable data storage in backend applications.",
  },
  {
    name: "JavaScript",
    level: 90,
...
const softSkills = [
  {
    name: "Communication",
    description: "The ability to express ideas clearly and effectively.",
  },
  {
    name: "Teamwork",
    description: "Working collaboratively to achieve a common goal.",
  },
  {
    name: "Problem-Solving",
    description: "Analyzing and resolving issues efficiently.",
  },
  { name: "Adaptability", description: "Being flexible and open to change." },
  {
    name: "Leadership",
    description: "Guiding and motivating a team towards success.",
  },
  {
    name: "Time Management",
    description: "Organizing tasks to maximize productivity.",
  },
];
  ...
  return (
    ...
    >
      <motion.div className="max-w-6xl mx-auto px-6">
        <h2 className="text-5xl font-extrabold text-center mb-12 glow-text">
          My Skills
        </h2>
        ...
        <h3 className="text-5xl font-extrabold text-center  mt-20 mb-8 glow-text">
          Soft Skills
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          {softSkills.map((skill, index) => (
            <div
              key={index}
              className={`p-6 bg-gray-800 rounded-lg shadow-lg cursor-pointer transition-all duration-300 group ${
                activeSkill === index
                  ? "scale-105 bg-gray-700"
                  : "hover:scale-105"
              }`}
              onClick={() => toggleDescription(index)}
            >
              <h4 className="text-xl  text-center font-semibold mb-2 text-white group-hover:text-cyan-500  transition-all duration-300">
                {skill.name}
              </h4>
              <div
                className={`text-gray-300 text-sm text-center transition-all duration-300 ${
                  activeSkill === index
        ...
        <h3 className="text-4xl font-extrabold text-center mt-20 mb-8 glow-text">
          Certifications
        </h3>
        <div className="flex flex-wrap justify-center gap-8">
          {certifications.map((cert, index) => (
            <div
              key={index}
              className="bg-gray-800 p-6 rounded-lg w-64 text-center hover:scale-105 transition-transform duration-300"
            >
